# Identification of Crop Nutrient Deficiencies Using Convolutional Neural Networks
...
The method uses a dataset of 1156 photos of rice leaves to categorize deficiencies in 
nitrogen (N), potassium (P), and phosphorus (K). The model was trained using Python and 
libraires such as scikit-learn and TensorFlow, with the maximum accuracy of 93.12% being 
...
- **Necessary Libraries** : zipfile,tensorflow, matplotlib, numpyseaborn, sklearn, streamlit.
## Technology Stack
